...
DONATE_STRING = """Heya, glad to hear you want to donate! To donate us go to :- [GZDonate Bot, click here](https://t.me/GZdonate_bot) , still, if needed any help [DM us](t.me/groupzoidsupportbot)."""
...
def donate(bot: Bot, update: Update):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 1106417794 and DONATION_LINK:
